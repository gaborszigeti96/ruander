...
function feltolto(feltoltendoElem) {
...
var olimpiaAdatok = feltolto(eredmenyek);
console.log('Pontszerző helyezések száma:' + olimpiaAdatok.length);
function ermeSzamlalo(adatok) {
    var aranyErem = 0;
    var ezustErem = 0;
    var bronzErem = 0;
...
function legtobbPontszerzo(adatok) {
    var legtobbSportoloIndex = 0;
    var legtobbSportolo = 0;
    for (var i = 0; i < adatok.length; i++) {
