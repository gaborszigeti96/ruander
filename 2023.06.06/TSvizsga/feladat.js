...
function LeetKod(vizsgaltSzoveg) {
    var szoveg = vizsgaltSzoveg.replace(/i/g, "1");
    var szoveg1 = szoveg.replace(/I/g, "1");
    var szoveg2 = szoveg1.replace(/o/g, "0");
    var szoveg3 = szoveg2.replace(/O/g, "0");
    var szoveg4 = szoveg3.replace(/a/g, "4");
    var szoveg5 = szoveg4.replace(/A/g, "4");
    var szoveg6 = szoveg5.replace(/e/g, "3");
    var szoveg7 = szoveg6.replace(/E/g, "3");
    /*
...
function LegtobbNyeremeny(vizsgaltTomb) {
    var legtobbpont = 0;
    for (var i = 0; i < vizsgaltTomb.length; i++) {
